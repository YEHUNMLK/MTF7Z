...
```bash
git clone https://github.com/USERNAME/MTF7Z.git
cd MTF7Z
```
...
This project was developed with the assistance of LLMs. The code was generated by LLMs, and the multilingual translations were also created with the help of LLMs.
